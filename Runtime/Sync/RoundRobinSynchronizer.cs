...
namespace TLP.UdonUtils.Runtime.Sync
{
    ...
    public class RoundRobinSynchronizer : TlpBaseBehaviour
    {
        ...
        {
            _expireTime = Time.time + SyncTimeoutSeconds;
        ...
        public override bool OnOwnershipRequest(VRCPlayerApi requestingPlayer, VRCPlayerApi requestedOwner)
        {
            ...
            if (!_currentPlayer.IsValidPlayer(out var currentPlayer) && requestedOwner.IsMasterSafe())
            {
        ...
        public void _CheckOwnershipReturned()
        {
            ...
            if (Networking.IsMaster &&
                Time.time > _expireTime - Time.deltaTime)
            {
