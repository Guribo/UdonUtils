...
namespace TLP.UdonUtils.Tests.Runtime.Utils
{
    public class UdonTestEnvironmentException : Exception
    {
        ...
        protected UdonTestEnvironmentException([NotNull] SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
