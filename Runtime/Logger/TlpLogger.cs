...
namespace TLP.UdonUtils.Runtime.Logger
{
    ...
    public class TlpLogger : TlpBaseBehaviour
    {
        ...
        protected virtual string GetPlayerInfo(UnityEngine.Object context)
        {
        ...
        public virtual void DebugLog(string logPrefix, string message, int executionOrder, UnityEngine.Object context)
        {
        ...
        public virtual void Info(string logPrefix, string message, UnityEngine.Object context)
        {
        ...
        public virtual void Warn(string logPrefix, string message, UnityEngine.Object context)
        {
        ...
        public virtual void Error(string logPrefix, string message, UnityEngine.Object context)
        {
