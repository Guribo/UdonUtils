...
namespace TLP.UdonUtils.Runtime
{
    ...
    public abstract class TlpBaseBehaviour : UdonSharpBehaviour
    {
        ...
        {
            return m_PendingSerializations > 0;
        }
        ...
        public bool DropPendingSerializations()
        {
            ...
            m_PendingSerializations = 0;
            return hadPending;
        }

        private int m_PendingSerializations;
        ...
        public bool MarkNetworkDirty()
        {
            ...
            m_PendingSerializations = Math.Max(1, m_PendingSerializations + 1);
...
#if TLP_DEBUG
                DebugLog(
                    $"{nameof(OnPostSerialization)} wrote {result.byteCount} bytes of {m_PendingSerializations} serialization requests to the network"
                );
#endif
                m_PendingSerializations = 0;
                return;
        ...
        {
#if TLP_DEBUG
            DebugLog(nameof(OnDeserialization));
#endif
        }
